...
function ArticleSectionsPage() {
    ...
    const uploadImageFile = async (file) => {
        ...
        // Using Free Article Upload Endpoint
        const uploadUrl = '/api/admin/articles/upload';
        ...
        return {
            ...
            id: data.id || data.gridfsId, // Handle both potential return keys
            size: data.size
        };
    };
    ...
    const handleAddSection = async () => {
        ...
        try {
            ...
            // Use the Unified Sections API
            const response = await fetch(`/api/admin/articles/${articleId}/sections`, {
                method: 'POST',
...
export default function ArticleSectionsPageWrapper() {
    return (
